...
declare module 'meteor/reywood:publish-composite' {
    ...
    interface PublishCompositeConfigN {
        ...
        find(this: Subscription, ...args: any[]): Mongo.Cursor<any> | void;
    }
